...
func (k *ExtendedKey) Neuter(pubKeyVersion [4]byte) (*ExtendedKey, error) {
	...
	return NewExtendedKey(pubKeyVersion[:], k.pubKeyBytes(), k.chainCode, k.parentFP,
...
func NewMaster(seed []byte, version [4]byte) (*ExtendedKey, error) {
	...
	return NewExtendedKey(version[:], secretKey, chainCode,
